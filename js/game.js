const game = {
    ...
    // Esto deberia estar en un archivo a parte?
    userActions: {
        righPressed: false,
        leftPressed: false
	},
	...
	refreshGame() {
		...
		this.gameInterval = setInterval(() => {
			...
			// console.log("CAR POSITION: ", this.car.posX, this.car.posY)
    ...
    // Board Drawing -- Estoy seguro de que esto se puede sacar a otro archivo para mejorar la limpieza
    // ----------------------------
    ...
    setEventListeners() {
        ...
        document.onkeydown = event => {
            ...
            event.keyCode === 37 ? this.car.move("left") : null
            event.keyCode === 39 ? this.car.move("right") : null
        }
