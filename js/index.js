...
ctx.fillText("PRESS F5 AND START GAME  TO PLAY AGAIN", 0, 400)
}
...
document.onkeydown = event => {
  ...
  case 38: thePlayer.speedY -= 1; break;
  case 40: thePlayer.speedY += 1; break;
  case 37: thePlayer.speedX -= 1; break;
  case 39: thePlayer.speedX += 1; break;

  // este caso 32 (tab) crea la funcion para iniciar el juego
  case 32: if (interval) startGame(); 
