window.onload = () => {
  ...
  // detect collisions, if there is one then end the game
  ...
  // Update score and remove obstacles outside the screen
	...
	function gameLoop() {
		...
		//3- Loop through the array: print and move every obstacle and check for a collision 
