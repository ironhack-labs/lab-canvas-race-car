window.onload = () => {
  ...
  let myObstacles = [], frames = 0, running = false, crashed = false, speed = 5, points = 0;
  ...
  function startGame() {
    if ( !running ) {
      ...
      if (crashed) {
        ...
        myObstacles = [], frames = 0, crashed = false, speed = 5, points = 0;  
  ...
  function stopGame() {
    ...
    if (crashed) {
      ...
      ctx.fillStyle = "white";
      ctx.fillText("Your final score:", canvas.width/2, canvas.height/2 + 40);
