...
function startGame() {
  ...
  barreras.forEach((barrera, indexBarrera) => {
    ...
    if (
      barrera.y + 30 >= coche.y &&
      coche.x + 50 >= barrera.x &&
      barrera.y <= coche.y + 80 &&
      barrera.x + 150 >= coche.x
    ) {
