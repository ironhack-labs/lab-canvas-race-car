console.log(`Your script aint fucked up`)
...
function updateObstacles() {
  ...
  if (myCanvas.frames % 240 === 0) {
    ...
    var start = Math.floor(Math.random()* (midPoint -  minStart + 1) + minStart);
    var finish = Math.floor(Math.random()* (maxEnd -  midPoint + 1) + midPoint);
...
let myCar = new Component(30, 60, 'blue', 160, 500);
